<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  ?>
      ...
      <a href="pages_dashboard.php" class="brand-link">
        <img src="../admin/dist/img/acleda_logo.png" alt="ACLEDA Logo" class="brand-image img-circle elevation-3" style="opacity: .92">
        <span class="brand-text font-weight-light">ACLEDA BANK Plc.</span>
      </a>
