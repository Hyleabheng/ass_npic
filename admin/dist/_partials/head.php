...
?>
    ...
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" type="image/png" sizes="16x16" href="dist/img/acleda_logo.png">
        <!-- Data Tables CSS -->
            ...
            function confirmDelete(url) {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        // For 'No', we can just stay on the page. 
                        // If we want a transition, we can show/hide loading briefly.
                        if (window.iBLoading && window.iBLoading.show) {
